    ...
    public class CursoDAO
    {
        public List<Curso> TraerTodo(MateriaConCorrelativas unaMateria)
        {
            ...
            try
            {
                ...
                resultado = unaConexion.EjecutarTupla<Curso>("SELECT FechaInicio FROM Curso c INNER JOIN MateriaConCorrelativas mcc on c.IdMateriaCC = (@IdMateriaCC) WHERE DATEDIFF(d, FechaInicio, GETDATE()) < 0 and c.CuposMax > 0", listaParametrosCD);
