    ...
    public class BitacoraDAO
    {
        public List<string> TraerTodosEventos()
        {
            ...
            try
            {
                ...
                resultado = unaConexion.EjecutarTupla<Bitacora2>("SELECT IdBitacora, IdUsuario, IdTipoBitacora, FechaHora, Mensaje, Habilitado FROM Bitacora", new List<Parametro>());
